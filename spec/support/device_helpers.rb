module DeviceHelpers
  ...
  def device_vendor_choices
    ...
    Factory(:device_vendor_choice, {:value => "Other", :sort_order => 3})
  end
  ...
  def device_kind_choices
    ...
    Factory(:device_kind_choice, {:value => "Other", :sort_order => 2})
  end
  ...
  def device_mobile_vendor_choices
    ...
    Factory(:device_mobile_vendor_choice, {:value => "Other", :sort_order => 2})
  end
  ...
  def device_mobile_kind_choices
    ...
    Factory(:device_mobile_kind_choice, {:value => "Other", :sort_order => 2})
  end
